...
publishing {
    publications {
        create<MavenPublication>("mixin-plugin-maven") {
            ...
            pom {
                name.set("Mixin Plugin")
                description.set("The Mixin plugin for YakClients Boot module.")
                url.set("https://github.com/yakclient/mixin-plugin")
                ...
                scm {
                    connection.set("scm:git:git://github.com/yakclient/mixin-plugin")
                    developerConnection.set("scm:git:ssh://github.com:yakclient/mixin-plugin.git")
                    url.set("https://github.com/yakclient/mixin-plugin")
                }
            }
        }
